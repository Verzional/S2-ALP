...
public class Populate {
        ...
        public void createCitadelEnemy() {
                citadelEnemies.add(new Enemy("Bonecrusher Warrior", 4, 50, 50, 50, 10, 5, 1, 1, 50,
                                new Weapon("Bone Axe", "A powerful axe made from bone", 17, 5, 100, 100),
                                new Armor("Bone Armor", "Armor crafted from sturdy bones", 17, 5, 100, 100,
                                                100)));
                citadelEnemies.add(new Enemy("Cursed Phantom Prince", 8, 50, 50, 50, 10, 5, 1, 1, 50,
                                new Weapon("Phantom Blade", "A spectral blade that curses its victims", 18, 5, 100,
                                                100),
                                new Armor("Phantom Cloak", "Cloak that renders the wearer ethereal", 18, 5, 100, 100,
                                                100)));
                citadelEnemies.add(new Enemy("Necroshade Princess", 12, 50, 50, 50, 10, 5, 1, 1, 50,
                                new Weapon("Necro Staff", "Staff imbued with life-draining magic", 19, 5, 100, 100),
                                new Armor("Shade Robe", "Robe that offers protection against shadows", 19, 5, 100, 100,
                                                100)));
                citadelEnemies.add(new Enemy("Titan of Shadows", 16, 50, 50, 50, 10, 5, 1, 1, 50,
                                new Weapon("Shadow Hammer", "Massive hammer that stuns enemies with darkness", 20, 5,
                                                100, 100),
                                new Armor("Titan Armor", "Heavy armor with shadow-infused shield", 20, 5, 100, 100,
                                                100)));
        }
        ...
        public void createBoss() {
                bossEnemies.add(new Enemy("The Dark Knight", 20, 200, 1000, 1500, 50, 50, 6, 1, 200,
                                new Weapon("Dark Sword", "Sword that slashes through darkness", 2, 20, 100, 100),
                                new Armor("Knight's Armor", "Armor worn by the legendary dark knight", 2, 20, 100, 100,
                                                100)));
